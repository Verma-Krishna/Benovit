  ...
  const components = [
    {
      ...
      name: "CNG Cylinder",
      description:
        "High-pressure cylinder stores compressed natural gas safely for engine use.",
      position: "left-[17%] top-[23%]",
    },
    {
      id: "fillingValve",
      name: "Filling Valve",
      description:
        "Used to refill the CNG tank securely, usually located near the rear side.",
      position: "left-[4%] top-[33%]",
    },
    {
      id: "pressureRegulator",
      name: "Pressure Regulator",
      description:
        "Reduces gas pressure from the cylinder to a stable level for engine supply.",
      position: "left-[56%] top-[53%]",
    },
    {
      id: "injectorRail",
      name: "Injector Rail",
      description:
        "Supplies controlled gas quantity to each cylinder ensuring optimal combustion.",
      position: "left-[59%] top-[61%]",
    },
    {
      id: "ecu",
      name: "CNG ECU (Control Unit)",
      description:
        "Manages CNG fuel injection timing and maintains performance balance.",
      position: "left-[67%] top-[36%]",
    },
    {
      id: "injector",
      name: "Injector",
...
const  products = [
  ...
  return (
    <>
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <section className="relative z-50 flex flex-col items-center justify-center text-center h-full px-6 pt-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-10">
            <button className="px-8 py-3 rounded-full text-lg font-semibold bg-white text-gray-900 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300">
              Get Started
            </button>
            <button className="px-8 py-3 rounded-full text-lg font-semibold border border-gray-400 text-white bg-transparent hover:bg-linear-to-r hover:from-green-500 hover:to-cyan-500 hover:border-transparent transition-all duration-300">
              Learn More
            </button>
          </div>
        </section>
      ...
      <section className="relative w-full py-16 bg-[#0063B2] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative w-[90%] md:w-[70%] max-w-5xl mx-auto">
          <div className="relative w-full h-[600px]">
            <Image
              src="/cng.png"
              alt="Benito Italy CNG System Diagram"
              fill
              priority
          ...
          {components.map((part) => (
            ...
            >
              ...
              <div className="relative">
                <div className="w-5 h-5 md:w-6 md:h-6 bg-blue-400 rounded-full shadow-lg animate-pulse cursor-pointer border-2 border-white hover:scale-110 transition-transform" />

                {/* Tooltip */}
                {hovered === part.id && (
                  <div className="absolute left-6 top-[-30px] md:left-8 md:-top-10 bg-linear-to-br from-blue-700 to-cyan-600 text-white rounded-xl p-4 w-64 shadow-xl backdrop-blur-xl border border-white/10 transition-all duration-300">
        ...
        <div className="mt-10 max-w-xl text-center bg-linear-to-br from-blue-800 to-cyan-700 text-white p-6 rounded-xl shadow-lg">
          <h3 className="text-sm leading-relaxed">
            Benito Italy CNG Kits are approved by State Transport of Delhi, Gujarat, Haryana,
            and Maharashtra. Sequential Kits are certified by ICAT Manesar for Euro IV OBD.
            Also approved under ISO-15500-9 from VCA, London.
          </h3>
        </div>
      </section>
