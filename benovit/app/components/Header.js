...
export default function Header() {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <nav
        className="fixed top-6 left-1/2 transform -translate-x-1/2 w-[90%] md:w-[80%] text-white px-8 py-3 flex justify-between items-center rounded-full shadow-lg border border-white/10 z-50 backdrop-blur-lg bg-linear-to-r from-emerald-600/20 via-cyan-600/20 to-green-500/20">
        {/* Logo */}
        ...
        <div className="hidden md:flex items-center space-x-10">
          ...
          <button className="bg-linear-to-r from-green-400 to-cyan-400 hover:from-green-500 hover:to-cyan-500 text-black font-semibold px-6 py-2 rounded-full shadow-md transition-transform duration-300 hover:scale-105">
            Get Quote
          </button>
        </div>
